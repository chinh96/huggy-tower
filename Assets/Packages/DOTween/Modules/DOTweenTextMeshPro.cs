...
namespace DG.Tweening
{
    ...
    public static class ShortcutExtensionsTMPText
    {
            ...
            CultureInfo culture = null)
        {
            ...
            TweenerCore<int, int, NoOptions> t = DOTween.To(() => v,
                x =>
                {
                    v = x;
    ...
    public class DOTweenTMPAnimator : IDisposable
    {
        ...
        public TweenerCore<Color, Color, ColorOptions> DOFadeChar(int charIndex, float endValue, float duration)
        {
            ...
            TweenerCore<Color, Color, ColorOptions> t = DOTween.ToAlpha(() => _charTransforms[charIndex].GetColor(textInfo.meshInfo),
        ...
        {
            if (!ValidateChar(charIndex)) return null;
            TweenerCore<Color, Color, ColorOptions> t = DOTween.To(() => _charTransforms[charIndex].GetColor(textInfo.meshInfo),
        ...
        {
            if (!ValidateChar(charIndex)) return null;
            TweenerCore<Vector3, Vector3, VectorOptions> t = DOTween.To(() => _charTransforms[charIndex].offset,
                x =>
                {
                    CharTransform charT = _charTransforms[charIndex];
                    charT.UpdateGeometry(target,
                        x,
                        charT.rotation,
                        charT.scale,
                        _cachedMeshInfos);
        ...
        {
            if (!ValidateChar(charIndex)) return null;
            TweenerCore<Quaternion, Vector3, QuaternionOptions> t = DOTween.To(() => _charTransforms[charIndex].rotation,
                x =>
                {
                    CharTransform charT = _charTransforms[charIndex];
                    charT.UpdateGeometry(target,
        ...
        {
            if (!ValidateChar(charIndex)) return null;
            TweenerCore<Vector3, Vector3, VectorOptions> t = DOTween.To(() => _charTransforms[charIndex].scale,
                x =>
                {
                    CharTransform charT = _charTransforms[charIndex];
                    charT.UpdateGeometry(target,
        ...
        public Tweener DOPunchCharOffset(int charIndex, Vector3 punch, float duration, int vibrato = 10, float elasticity = 1)
        {
            ...
            return DOTween.Punch(() => _charTransforms[charIndex].offset,
                x =>
                {
                    CharTransform charT = _charTransforms[charIndex];
                    charT.UpdateGeometry(target,
        ...
        public Tweener DOPunchCharRotation(int charIndex, Vector3 punch, float duration, int vibrato = 10, float elasticity = 1)
        {
            ...
            return DOTween.Punch(() => _charTransforms[charIndex].rotation.eulerAngles,
                x =>
                {
                    CharTransform charT = _charTransforms[charIndex];
                    charT.UpdateGeometry(target,
        ...
        {
            return DOPunchCharScale(charIndex,
        ...
        public Tweener DOPunchCharScale(int charIndex, Vector3 punch, float duration, int vibrato = 10, float elasticity = 1)
        {
            ...
            return DOTween.Punch(() => _charTransforms[charIndex].scale,
                x =>
                {
                    CharTransform charT = _charTransforms[charIndex];
                    charT.UpdateGeometry(target,
        ...
        {
            return DOShakeCharOffset(charIndex,
                duration,
        ...
        public Tweener DOShakeCharOffset(int charIndex, float duration, Vector3 strength, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            ...
            return DOTween.Shake(() => _charTransforms[charIndex].offset,
                x =>
                {
                    CharTransform charT = _charTransforms[charIndex];
                    charT.UpdateGeometry(target,
        ...
        public Tweener DOShakeCharRotation(int charIndex, float duration, Vector3 strength, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            ...
            return DOTween.Shake(() => _charTransforms[charIndex].rotation.eulerAngles,
                x =>
                {
                    CharTransform charT = _charTransforms[charIndex];
                    charT.UpdateGeometry(target,
        ...
        {
            return DOShakeCharScale(charIndex,
                duration,
                new Vector3(strength, strength, strength),
                vibrato,
                randomness,
        ...
        public Tweener DOShakeCharScale(int charIndex, float duration, Vector3 strength, int vibrato = 10, float randomness = 90, bool fadeOut = true)
        {
            ...
            return DOTween.Shake(() => _charTransforms[charIndex].scale,
                x =>
                {
                    CharTransform charT = _charTransforms[charIndex];
                    charT.UpdateGeometry(target,
        ...
        struct CharTransform
        {
            ...
            public Color32 GetColor(TMP_MeshInfo[] meshInfos) { return meshInfos[_matIndex].colors32[_firstVertexIndex]; }

            public CharVertices GetVertices()
            {
                return new CharVertices(_meshInfo.vertices[_firstVertexIndex],
            ...
            public void UpdateGeometry(TMP_Text target, Vector3 offset, Quaternion rotation, Vector3 scale, TMP_MeshInfo[] cachedMeshInfos, bool apply = true)
            {
                ...
                destinationVertices[_firstVertexIndex] = matrix.MultiplyPoint3x4(destinationVertices[_firstVertexIndex + 0]) + _charMidBaselineOffset + _bottomLeftShift;
