...
public class TGRankController : Singleton<TGRankController>
{
    ...
    public void Show()
    {
        if (Data.PlayerId == "")
        {
            PopupController.Instance.Show<LeaderboardLoginPopup>(2, ShowAction.DoNothing);
        }
        else
        {
            PopupController.Instance.Show<TGRankPopup>(null, ShowAction.DoNothing);
        }
    }
