...
public static class TGDatas
{
    ...
    public static TimeSpan TimeToTG => new DateTime(2022, 1, 23, 0, 0, 0) - DateTime.Now;
    public static bool IsInTG => DateTime.Now > new DateTime(2022, 1, 20, 0, 0, 0) && new DateTime(2022, 3, 14, 0, 0, 0) > DateTime.Now;
