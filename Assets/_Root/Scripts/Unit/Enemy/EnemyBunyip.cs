...
public class EnemyBunyip : Unit, IAnim
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(EnemyBunyip))]
public class EnemyBunyipEditor : UnityEditor.Editor
{
    private EnemyBunyip _enemy;

    private void OnEnable() { _enemy = (EnemyBunyip)target; }
