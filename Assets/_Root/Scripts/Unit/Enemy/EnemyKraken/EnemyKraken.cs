...
public class EnemyKraken : Unit, IAnim
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(EnemyKraken))]
public class EnemyKrakenEditor : UnityEditor.Editor
{
    private EnemyKraken _enemy;

    private void OnEnable() { _enemy = (EnemyKraken)target; }
