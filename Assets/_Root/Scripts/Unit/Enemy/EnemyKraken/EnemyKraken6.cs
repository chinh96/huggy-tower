...
public class EnemyKraken6 : Unit, IAnim
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(EnemyKraken6))]
public class EnemyKraken6Editor : UnityEditor.Editor
{
    private EnemyKraken6 _enemy;

    private void OnEnable() { _enemy = (EnemyKraken6)target; }
