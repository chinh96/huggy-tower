...
public class EnemyKraken5 : Unit, IAnim
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(EnemyKraken5))]
public class EnemyKraken5Editor : UnityEditor.Editor
{
    private EnemyKraken5 _enemy;

    private void OnEnable() { _enemy = (EnemyKraken5)target; }
