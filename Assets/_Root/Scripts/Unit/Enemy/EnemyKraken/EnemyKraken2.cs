...
public class EnemyKraken2 : Unit, IAnim
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(EnemyKraken2))]
public class EnemyKraken2Editor : UnityEditor.Editor
{
    private EnemyKraken2 _enemy;

    private void OnEnable() { _enemy = (EnemyKraken2)target; }
