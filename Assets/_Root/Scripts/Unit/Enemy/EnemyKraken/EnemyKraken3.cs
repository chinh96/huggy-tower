...
public class EnemyKraken3 : Unit, IAnim
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(EnemyKraken3))]
public class EnemyKraken3Editor : UnityEditor.Editor
{
    private EnemyKraken3 _enemy;

    private void OnEnable() { _enemy = (EnemyKraken3)target; }
