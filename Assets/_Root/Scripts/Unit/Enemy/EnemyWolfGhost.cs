...
public class EnemyWolfGhost : Unit, IAnim
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(EnemyWolfGhost))]
public class EnemyWolfGhostEditor : UnityEditor.Editor
{
    private EnemyWolfGhost _enemy;

    private void OnEnable() { _enemy = (EnemyWolfGhost)target; }
