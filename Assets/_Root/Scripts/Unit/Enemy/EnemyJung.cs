...
public class EnemyJung : Unit, IAnim
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(EnemyJung))]
public class EnemyJungEditor : UnityEditor.Editor
{
    private EnemyJung _enemy;

    private void OnEnable() { _enemy = (EnemyJung)target; }
